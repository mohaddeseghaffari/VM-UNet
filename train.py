...
def main(config):
    ...
    # چون دیتاست شما کوچک است، همان validation را برای train استفاده می‌کنیم
    train_dataset = ISIC17Dataset(config.data_path, config, train=True)
